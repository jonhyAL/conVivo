...
<body class="min-h-screen bg-slate-950 flex items-center justify-center p-4 font-sans text-slate-300 relative">
    ...
    <div class="relative w-full max-w-6xl z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div class="hidden lg:flex flex-col items-center justify-center p-8">
                ...
                <p class="mt-4 text-slate-400 text-center max-w-md text-lg font-light leading-relaxed">
                    Crea tu cuenta y forma parte de una comunidad comprometida con la prevención y el apoyo.
                </p>
            </div>
            ...
            <div class="w-full">
                ...
                <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-black/50 p-8 lg:p-12 relative overflow-hidden">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Name -->
                        <div class="mb-5">
                            <label for="name" class="block text-slate-600 text-sm font-bold mb-2 ml-1">
                                Nombre completo
                            </label>
                            <input 
                                type="text" 
                        ...
                        <div class="mb-6">
                            <label for="password_confirmation" class="block text-slate-600 text-sm font-bold mb-2 ml-1">
                    ...
                    <div class="relative my-8">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-4 bg-white text-slate-400 font-medium rounded-full">O regístrate con</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-slate-500 text-sm">
                            ¿Ya tienes cuenta? 
                            <a href="{{ route('login') }}" class="text-teal-600 hover:text-teal-500 font-bold transition-colors">
                                Inicia sesión aquí
                            </a>
                        </p>
                    </div>
        ...
        <!-- Footer -->
        <div class="mt-12 text-center text-slate-500 text-xs text-opacity-70">
