...
<body class="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 font-sans text-slate-600 dark:text-slate-300 relative transition-colors duration-300">
    ...
    <div class="relative w-full max-w-6xl z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <!-- Lado izquierdo: Logo -->
            <div class="hidden lg:flex flex-col items-center justify-center p-8 text-center">
                ...
                <h2 class="text-5xl font-bold text-slate-800 dark:text-white tracking-tight leading-tight mb-6 transition-colors duration-300">
                    Bienvenido de <br/>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-cyan-500 to-blue-500 dark:from-teal-200 dark:via-cyan-200 dark:to-blue-200">
                        vuelta.
                    </span>
                </h2>
                
                <p class="text-slate-600 dark:text-slate-400 text-lg font-light leading-relaxed max-w-md transition-colors duration-300">
            ...
            <div class="w-full">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 dark:shadow-black/50 p-8 lg:p-12 relative overflow-hidden transition-colors duration-300">
                    ...
                    @if ($errors->any())
                        <div class="mb-6 bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-500/30 text-red-600 dark:text-red-400 px-5 py-4 rounded-2xl text-sm shadow-sm flex items-center">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <label class="flex items-center cursor-pointer group">
                                <input type="checkbox" name="remember" class="w-4 h-4 rounded border-slate-300 dark:border-slate-600 bg-slate-100 dark:bg-slate-700 text-teal-600 focus:ring-teal-500">
                                <span class="ml-2 text-sm text-slate-500 dark:text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-300 transition-colors">Recordarme</span>
                            </label>
                            <a href="#" class="text-sm text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 font-medium transition-colors">
                    ...
                    <div class="relative my-8">
                        <div class="absolute inset-0 flex items-center">
                            <div class="w-full border-t border-slate-200 dark:border-slate-600 transition-colors duration-300"></div>
                        </div>
                        <div class="relative flex justify-center text-sm">
                            <span class="px-4 bg-white dark:bg-slate-800 text-slate-400 dark:text-slate-500 font-medium rounded-full transition-colors duration-300">O continuar con</span>
                        </div>
                    </div>
        ...
        <!-- Footer -->
        <div class="mt-12 text-center text-slate-500 dark:text-slate-400 text-xs transition-colors duration-300">
